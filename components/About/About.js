                ...
                <div className="about_container">
                    ...
                    >
                        <div className="card_face_one">
                            ...
                            <p>
                                We are masters in innovative, agile creative
                                approach in producing websites.
                            </p>
                        </div>
                        <div className="card_face_one">
                            <h3>We are creative</h3>
                            <p>
                                We create highly-usable websites that are
                                powered by an array of technologies and then we
                                analyze performance data to optimize and refine.
                            </p>
                        </div>
                    </ReactCardFlipper>
                    ...
                    >
                        <div className="card_face_two">
                            ...
                            <p>
                                Our approach to work process, from sketch to
                                development, is focused towards
                            </p>
                        </div>
                        <div className="card_face_two">
                            <h3>We are creative</h3>
                            <p>
                                Our approach to work process, from sketch to
                                development, is focused towards creating an
                                unforgettable user impression. It’s true magic
                                when the concept comes to life in a
                                pixel-perfect design and fully functional
                                website.{" "}
                            </p>
                        </div>
                    </ReactCardFlipper>
                    ...
                    >
                        <div className="card_face_three">
                            ...
                            <p>
                                We create highly-usable websites that are
                                powered by an array of technologies
                            </p>
                        </div>
                        <div className="card_face_three">
                            <h3>We are creative</h3>
                    ...
                    >
                        <div className="card_face_four">
                            ...
                            <h3>Best team</h3>
                            <p>
                                Our team provides personal, professional and
                                friendly service which carefully
                            </p>
                        </div>
                        <div className="card_face_four">
                            <h3>We are creative</h3>
                            <p>
                                Our team provides personal, professional and
                                friendly service which carefully considers your
                                business goals and requirements. We transform
                                innovative visions into brilliant realities. Got
                                one? Let’s make outstanding work together!{" "}
                            </p>
                        </div>
                    </ReactCardFlipper>
                </div>
