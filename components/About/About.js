        ...
        <div className="about_container">
          <ReactCardFlipper width="300px" height="450px" behavior="hover">
            <div className="card_face_one">
              ...
              <p>
                We are masters in innovative, agile creative approach in
                producing websites.
              </p>
            </div>
            <div className="card_face_one">
              ...
              <p>
                ...
                technologies and then we analyze performance data to optimize
                and refine.
              </p>
            </div>
          </ReactCardFlipper>
          ...
          <ReactCardFlipper width="300px" height="450px" behavior="hover">
            <div className="card_face_two">
              ...
              <p>
                Our approach to work process, from sketch to development, is
                focused towards
              </p>
            </div>
            <div className="card_face_two">
              ...
              <p>
                Our approach to work process, from sketch to development, is
                focused towards creating an unforgettable user impression. It’s
                true magic when the concept comes to life in a pixel-perfect
                design and fully functional website.{" "}
              </p>
            </div>
          </ReactCardFlipper>
          ...
          <ReactCardFlipper width="300px" height="450px" behavior="hover">
            ...
            <div className="card_face_four">
              ...
              <p>
                Our team provides personal, professional and friendly service
                which carefully considers your business goals and requirements.
                We transform innovative visions into brilliant realities. Got
